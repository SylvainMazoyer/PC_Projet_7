...
def predict_selected_sku(sku):
    ...
    list_features=list_features[0:10]
    list_abs_shap_values=list_abs_shap_values[0:10]
    st.header("2. Absolute importance of features for help to decision")
    fig = px.bar(x=list_features, y=list_abs_shap_values)#, title="Importance of features")
